...
var neighborName = "Alice";
console.log(neighborName);
var teacherName = "Mary";
...
var japanPrefectures = ["Tokyo", "Kyoto", "Osaka", "Miyagi", "Nara"];
...
Console log the variable.*/
var india = ["Taj Mahal", "Ghanges", "The Red Fort"];
console.log(india);
